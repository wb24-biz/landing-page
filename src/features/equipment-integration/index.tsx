        ...
        <div className="grid grid-cols-2 gap-6 ">
          <div className="flex flex-col items-start px-4">
            ...
            <div className="flex flex-col gap-4">
              <div className="rounded-3xl border border-[#136EFF] px-8 py-4">
                <h4 className="text-white text-lg font-bold">GSM-WB24</h4>
                <p className="text-[#fff]/80 text-sm font-medium">
                  модуль обміну, управління та передавання даних на&nbsp;сервіс
                  wb24.biz
                </p>
              </div>
              <div className="rounded-3xl border border-[#136EFF] px-8 py-4">
                ...
                <p className="text-[#fff]/80 text-sm font-medium">
                  безконтактний зчитувач та інформаційно-платіжний термінал для
                  безготівкової оплати з підтримкою NFC/QR, фіскалізації та
                  видачі чеків
                </p>
              </div>
            </div>
