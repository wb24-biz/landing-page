...
const FunctionalFeatures = () => {
  return (
    <section className="py-16 rounded-[40px] my-12 bg-[url('/images/frame.svg')] bg-center bg-no-repeat bg-cover">
      <div className="container mx-auto">
        ...
        <p className="text-center text-lg text-[#6A7281] mb-12 max-w-3xl mx-auto">
          ...
          контролювати в режимі онлайн 24/7, максимально оптимізувати і звести
          до нуля простої обладнання, а також значно скоротити витрати на
